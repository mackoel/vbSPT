function W0=VB4_createTrajectories(dat,W0,muStd,muCov)
% function W0=VB4_createTrajectories(dat,W0,muStd,muCov)
% 
% Creates a trajectory field Etrj based on the VB4 data dat, that can be
...
%% copyright notice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VB4_createTrajectories, creates an initial VB4 hidden trajectory. Part of
% the vbSPT suite.
% =========================================================================
% 
...
if(~exist('W0','var')|| isempty(W0))    
    ...
    if(isfield(W0,'dim') && W0.dim~=dim)
        warning('VB4_createTrajectory: model dimensionality changed.')
    end    
    W0.Etrj=Etrj;
    W0.dim=dim;
end
