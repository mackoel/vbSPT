function [x,s,y]=VB4_diffusiveHMM_blur_detach(p0,A,pE,Ddt,R,tau,sigErr,dim,T,numTrj)
% [x,s,y]=VB4_diffusiveHMM_blur_detach(p0,A,pE,Ddt,R,tau,sigErr,dim,T,numTrj)
%
...
%% copyright notice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VB4_diffusiveHMM_blur_detach.m, simulate d-dimensional diffusion with 
...
[N,NN]=size(A);
if(N~=NN)
    error('VB4_diffusiveHMM_blur_detach requires square transition matrix')
end
clear NN
