function X=VB5_readData(runinput)
% X=VB5_readData(runinput)
% 
% Read diffusion data set as specified in a runinputfile. It is also possible
% to use an options structure, e.g., from opt=VB5_getOptions(runinputfile) instead.
...
%% copyright notice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VB5_readData.m, reads position data for the VB5 suite in vbSPT
% =========================================================================
% 
...
elseif(isstruct(runinput))
    ...
    error('Not a valid input, aborting VB5_readData');
end
...
if(isfield(opt,'trjLmin'))
    ...
    warning('VB5_readData: cannot find minimum trajectory length in opt structure. Using minimum value: trjLmin=2');
    Lmin=2;
end
