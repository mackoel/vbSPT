function W0=VB5_newParameters(Ddt,locErr,A,p0,strength,W0)
% function W1=VB5_newParameters(Ddt,locErr,A,p0,strength,W0)
% 
...
%% copyright notice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VB5_newParameters, part of the vbSPT suite
% =========================================================================
% 
...
lambda=sort(eig(A));
if(abs(lambda(end)-1)>1e-13) % then there is no proper stationary state
    error('VB5_createModdel: A does not seem to be a proper transition matrix')
end
