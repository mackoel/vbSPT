function res=VB5_getResult(runinput)
% res=VB5_getResult(runinput)
%
...
%% copyright notice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VB5_getResult.m, loads VB5 analysis results for the vbSPT package
% =========================================================================
%
...
disp(num2str(res.Wbest.est.DMean, 3));
%disp(sprintf('\n'));
disp('-------------------------')
disp(['RMS localization errors: ']);
disp(num2str(sqrt(res.Wbest.est.sig2Mean), 3));
%disp(sprintf('\n'));
disp('-------------------------')
disp(['Occupancy: ']);
